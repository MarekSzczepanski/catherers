...
const mockUpdateFeatureScore = vi.fn();
const mockHandleClick = vi.fn();
const mockClickedButtons = new Set<string>();
const mockLockedButtons = new Set<string>();
...
describe("AccordionContent", () => {
  it("renders buttons", () => {
    render(
      <AccordionContent
        data={mockData}
        updateFeatureScore={mockUpdateFeatureScore}
        handleClick={mockHandleClick}
        clickedButtons={mockClickedButtons}
        lockedButtons={mockLockedButtons}
      />
    );
